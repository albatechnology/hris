...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payroll_components', function (Blueprint $table) {
            ...
            // $table->double('daily_maximum_amount', 13, 2)->unsigned()->default(0)->comment('Only for the data which had the "daily" value of period_type column and is_daily_default is false (0) and daily_maximum_amouont_type IN(basic_salary_percentage, custom_amount)');
            ...
            $table->boolean('is_calculate_thr')->default(0);
