                                    ...
                                    <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td style="line-height: 24px; font-size: 16px; margin: 0;">
                                            <img src="https://i.imgur.com/cIcfRPt.png" class="img-fluid" style="width: 80px;height: 80px;top: 223px;left: 680px;padding: 0 6.67px 0 6.67px;gap: 0px;opacity: 0px;">
                                          </td>
                                          <td style="line-height: 24px; font-size: 16px; margin: 0;">
                                            <img src="https://i.imgur.com/7vjYqDi.png" class="img-fluid" style="border: 1px solid #000000">
                                          </td>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                          <h4 class="text-center" style="padding-top: 20px; padding-bottom: 20px; font-weight: 500; vertical-align: baseline; font-size: 24px; line-height: 28.8px; margin: 0;" align="center">Hi, <b>{{ $user->name }}</b></h4>
