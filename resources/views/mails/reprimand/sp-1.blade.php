...
<body>
    ...
    <div class="mt-5">
        <p>
            ...
            @if ($job_position)
                <span class="highlight">{{ $job_position }}</span><br>
            @endif
            @if ($job_level)
                <span class="highlight">{{ $job_level }}</span><br>
            @endif
        </p>
    </div>
    ...
    <p>
        ...
        occurred consistently over the past five consecutive months, from [Month 1] through [Month 5] of [Year].
    </p>
