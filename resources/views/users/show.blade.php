                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="{{ route('users.edit', $model->id) }}" class="btn btn-warning btn-block"><i
                                    class="fas fa-edit"></i> <b>Edit</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#basic-info" data-toggle="tab">Basic
                                        Info</a></li>
                                <li class="nav-item"><a class="nav-link" href="#contacts" data-toggle="tab">Contacts</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="#educations" data-toggle="tab">Educations</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="#experiences"
                                        data-toggle="tab">Experiences</a></li>
                                <li class="nav-item"><a class="nav-link" href="#additional-info"
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="basic-info">
                                    ...
                                    <div class="card-body box-profile">
                                        ...
                                        <div>
                                            <p class="h4 pb-2 mt-5 text-dark border-bottom border-dark">Identity & Address
                                            </p>
                                        </div>
                                        <div class="active tab-pane" id="basic-info">
                                            <div class="card-body box-profile">
                                ...
                                <div class="tab-pane" id="contacts">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="#contacts-family"
                                                data-toggle="tab">Family</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#contacts-emergency"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="contacts-family">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($model->contacts->where('type', \App\Enums\ContactType::FAMILY) as $i => $contact)
                                                        <tr>
                                                            <th scope="row">{{ ++$i }}</th>
                                                            <td>{{ $contact->name }}</td>
                                        ...
                                        <div class="tab-pane" id="contacts-emergency">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($model->contacts->where('type', \App\Enums\ContactType::EMERGENCY) as $i => $contact)
                                                        <tr>
                                                            <th scope="row">{{ ++$i }}</th>
                                                            <td>{{ $contact->name }}</td>
                                                            <td>{{ $contact->relationship }}</td>
                                ...
                                <div class="tab-pane" id="educations">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="#educations-formal"
                                                data-toggle="tab">Formal</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#educations-informal"
                                                data-toggle="tab">Informal</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="educations-formal">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($model->educations->where('type', \App\Enums\EducationType::FORMAL) as $i => $edication)
                                                        <tr>
                                                            <th scope="row">{{ ++$i }}</th>
                                        ...
                                        <div class="tab-pane" id="educations-informal">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($model->educations->where('type', \App\Enums\EducationType::INFORMAL) as $i => $edication)
                                                        <tr>
                                                            <th scope="row">{{ ++$i }}</th>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="experiences">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($model->experiences as $i => $experience)
                                                        <tr>
                                                            <th scope="row">{{ ++$i }}</th>
                                        ...
                                        <div class="tab-pane active" id="additional-info">
                                            <dl class="row">
                                                @foreach ($customFields as $customField)
                                                    <dt class="col-sm-5">{{ $customField->key }}</dt>
                                                    <dd class="col-sm-7">{{ $customField->value ?? '-' }}</dd>
                                                @endforeach
                                            </dl>
                                        </div>
                                    </div>
