...
<body>
    <div>
            ...
            <tbody>
                @foreach ($patrol->patrolLocations as $patrolLocation)
                    <tr>
                        ...
                        <td style="background: #b4c7dc; height: 100px;">{{ $patrolLocation->branchLocation->address }}
                        </td>
                        <td
                            style="background: #b4c7dc; height: {{ max($patrolLocation->tasks->count() * 23, 100) }}px;">
                            <ol>
        ...
        <table>
            <colgroup>
                <col style="width: 100pt;"> <!-- Kolom 1 -->
                <col style="width: 150pt;"> <!-- Kolom 2 -->
                <col style="width: 200pt;"> <!-- Kolom Bukti Foto -->
