<table>
    <thead>
        <tr>
            ...
            <th style="text-align: center; font-weight: bold" rowspan="2">NPWP</th>
            <th style="text-align: center; font-weight: bold" rowspan="2">PTKP</th>
        </tr>
        <tr>
        ...
        @foreach ($activeUsers as $group)
            ...
            @foreach ($group as $runPayrollUser)
                ...
                <tr>
                    ...
                    <td>{{ $runPayrollUser->user?->payrollInfo?->npwp ?? '' }}</td>
                    <td>{{ $runPayrollUser->user?->payrollInfo?->ptkp_status->value ?? '' }}</td>
                </tr>
            @endforeach
            <tr>
                <td colspan="7" style="font-weight: bold; background: #ffcbb1;">TOTAL</td>
