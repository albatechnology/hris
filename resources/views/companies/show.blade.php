            ...
            <div class="col-12">
                <div class="card card-orange card-outline">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-muted text-center">{{ $model->group->name }}</p>
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Currency Code</b>
                                <p class="float-right">{{ $model->currency_code->getLabel() }}</p>
                            </li>
                            <li class="list-group-item">
                                <b>Last Update</b>
                        ...
                        <a href="{{ route('companies.edit', $model->id) }}" class="btn btn-warning btn-block"><i class="fas fa-edit"></i> <b>Edit</b></a>
                    </div>
                </div>
            </div>
        </div>
