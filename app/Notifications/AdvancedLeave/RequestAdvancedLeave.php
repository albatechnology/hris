...
class RequestAdvancedLeave extends Notification
{
    use Queueable;
     ...
     */
    public function __construct(private NotificationType $notificationType, private User $user, private AdvancedLeaveRequest $advancedLeaveRequest)
    {
        //
    }
    ...
    {
        $body = sprintf($this->notificationType->getMessage(), $this->advancedLeaveRequest->amount, $this->advancedLeaveRequest->amount > 1 ? 'days' : 'day');
        ...
        return [
            ...
            'data' => [
                ...
                'notifiable_id' => $this->advancedLeaveRequest->id,
            ],
        ];
    }
}
