...
class RequestReimbursementApproved extends Notification
{
    use Queueable;
     ...
     */
    public function __construct(private NotificationType $notificationType, private User $user, private ApprovalStatus $approvalStatus, private Reimbursement $reimbursement)
    {
        //
    }
