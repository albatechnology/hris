...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'position_id' => ['nullable', new CompanyTenantedRule(Position::class, 'Position not found')],
            'department_id' => ['nullable', new CompanyTenantedRule(Department::class, 'Department not found')],
