    ...
    protected static function booted(): void
    {
        ...
        static::created(function (self $model) {
            ...
            if ($model->type->is(ResignationType::REHIRE)) {
                ...
                $upahBpjsKetenagakerjaan = CountrySetting::where('country_id', $model->branch->company->country_id)->where('key', CountrySettingKey::JP_MAXIMUM_SALARY)->value('value') ?? 11086300;
