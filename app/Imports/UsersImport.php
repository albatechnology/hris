...
class UsersImport implements ToModel, WithHeadingRow, WithValidation, WithMultipleSheets
{
    ...
    public function rules(): array
    {
        return [
            ...
            'job_position_id' => ['nullable', new CompanyTenantedRule(JobPosition::class, 'Job Position not found')],
            'job_level_id' => ['nullable', new CompanyTenantedRule(JobLevel::class, 'Job Level not found')],
