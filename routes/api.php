...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    ...
    Route::group(['prefix' => 'divisions/{division}'], function () {
        Route::put('restore', [DivisionController::class, 'restore']);
        Route::delete('force', [DivisionController::class, 'forceDelete']);
    });
    Route::apiResource('divisions', DivisionController::class);

    Route::group(['prefix' => 'departments/{department}'], function () {
        Route::put('restore', [DepartmentController::class, 'restore']);
        Route::delete('force', [DepartmentController::class, 'forceDelete']);
    });
    ...
    Route::delete('user-patrol-batches/{user_patrol_batch}/force', [UserPatrolBatchController::class, 'forceDelete']);
